...
export function Permissions() {
  ...
  const [pastePermission, setPastePermission] = useState<PermissionStatus>('none');
    ...
    <>
      <div>
        <CardHeader>
          ...
          <CardDescription>Enable the following permissions to get started</CardDescription>
        </CardHeader>
        <CardContent className="grid gap-6">
          <div className="flex items-center justify-between space-x-4 bg-slate-50 px-4 py-3 rounded-lg">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Required to record audio</p>
              </div>
            </div>
            <div>
              {micPermission === 'none' && (
          ...
          <div className="flex items-center justify-between space-x-4  bg-slate-50 px-4 py-3 rounded-lg">
            <div className="flex items-center space-x-4">
              <Keyboard />
              <div>
                <p className="text-sm font-medium leading-none">Accessibility</p>
